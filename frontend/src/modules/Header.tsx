      ...
      ${location.pathname === "/wishlist"
            ...
            {!isAuthenticated ? (
              <div className="hidden md:flex gap-3">
                <Link
                  to="/login"
                  className="px-5 py-2 rounded-full text-sm font-medium text-indigo-600 border border-indigo-600 hover:bg-indigo-50 transition"
                >
                  Login
                </Link>
                <Link
                  to="/signup"
                  className="px-5 py-2 rounded-full text-sm font-medium text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:opacity-90 shadow-md transition"
                >
                  Sign Up
                </Link>
              </div>
