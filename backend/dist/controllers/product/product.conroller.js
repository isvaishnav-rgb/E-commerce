...
const updateProduct = async (req, res) => {
    try {
        ...
        const product = await Product_model_1.default.findByIdAndUpdate(req.params.id, updateData, { new: true });
        res.json({
...
const deleteProduct = async (req, res) => {
    try {
        await Product_model_1.default.findByIdAndUpdate(req.params.id, {
            isDeleted: true,
        });
